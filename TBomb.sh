...
echo -e "\e[4;30m MODIFIED BY H420 \e[0m"
...
echo This modified Script Was Made By H420 >update.speedx
...
echo -e "\e[4;34m This Bomber Was Created By SpeedX and modified by H420 \e[0m"
